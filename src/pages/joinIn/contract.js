    ...
    return (
      <div className={styles.contract}>
        ...
        <p className={styles.content}>
          ...
          3. 合作期内，甲方为乙方提供纳品网平台所供货品 100%包退换服务支持（人为原因损坏的除外）且乙方市场定价不得超出纳品网平台进货价 1.3 倍。<br/>
          4. 乙方进货价按照平台价格6.5折结算。<br/>

          5. 纳品网 APP 平台所有上架商品展现价格，均为不含税价。如乙方需要开发票，需额外承担 8%税点。<br/>
          6. 除次品退货以外的运费，均由乙方承担。<br/>
          二、协议的续签与解除<br/>
        ...
        <div className={styles.footer}>
          ...
          <div className={styles.secondPart}>
            ...
            {/*<div>乙方代表签字/盖章: {signImage && signImage.length > 0 ? getImg : <Button onClick={() => {*/}
            {/*this.setState({showModal: true})*/}
            {/*}}>签字</Button>}*/}
            {/*</div>*/}

            <div>乙方代表签字/盖章:{name}</div>
            <div>日期:{signTime}</div>
          </div>
        </div>
        ...
        <div>
          <Modal visible={this.state.showModal}
            ...
            <div>
              <p>请在下面签名:</p>
              <div id='signature' className="js-signature" data-width="600" data-height="200"
